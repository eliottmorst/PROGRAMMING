...
int start()
{
  ...
  {
     int result=0;
     if((Close[0]>iFractals(NULL,0,MODE_LOWER,0))) // Here is your open buy rule
     {
     ...
     if((Close[0]<iFractals(NULL,0,MODE_LOWER,0))) // Here is your open Sell rule
     {
